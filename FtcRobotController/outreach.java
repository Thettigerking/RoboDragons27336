...
// ---- Tilt Toggle with Debounce ----
            ...
            if (gamepad2.dpad_down) {
                if (RightOuttake.getVelocity() < -1025) {
                    RightOuttake.setPower(0);

                } else if (RightOuttake.getVelocity() > -975){
                    RightOuttake.setPower(-1);
                } else {
                    RightOuttake.setVelocity(-1000);
                }
                if (LeftOuttake.getVelocity() < -1025) {
                    LeftOuttake.setPower(0);
                } else if (LeftOuttake.getVelocity() > -975){
                    LeftOuttake.setPower(-1);
                } else {
                    LeftOuttake.setVelocity(-1000);
                }
